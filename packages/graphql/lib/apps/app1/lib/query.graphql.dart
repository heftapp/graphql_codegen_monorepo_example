import '../../../packages/feature1/lib/fragment.graphql.dart';
import 'dart:async';
...
class Query$Q {
  ...
  factory Query$Q.fromJson(Map<String, dynamic> json) {
    ...
    return Query$Q(
      user: l$user == null
          ? null
          : Fragment$F.fromJson((l$user as Map<String, dynamic>)),
      $__typename: (l$$__typename as String),
    );
  }

  final Fragment$F? user;
...
abstract class CopyWith$Query$Q<TRes> {
  ...
  CopyWith$Fragment$F<TRes> get user;
}
...
class _CopyWithImpl$Query$Q<TRes> implements CopyWith$Query$Q<TRes> {
  ...
  TRes call({
    ...
    Object? $__typename = _undefined,
      ...
      _then(Query$Q(
        user: user == _undefined ? _instance.user : (user as Fragment$F?),
  ...
  CopyWith$Fragment$F<TRes> get user {
    ...
    return local$user == null
        ...
        : CopyWith$Fragment$F(local$user, (e) => call(user: e));
  }
}
...
class _CopyWithStubImpl$Query$Q<TRes> implements CopyWith$Query$Q<TRes> {
  ...
  CopyWith$Fragment$F<TRes> get user => CopyWith$Fragment$F.stub(_res);
}
